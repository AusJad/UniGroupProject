...
local function loadResources(AMAN)
	...
	AMAN:addModel("./Resources/Models/skybox.obj", "IM", "SKYBOX", vec3(650,500,650));
...
function initGame(SM, LSM, AMAN, AE)
	...
	--SM:addObject(Identifiers("PROP", "SKYBOX"), level1, vec3(0,-5000,-4000), ResourceList("model", "SKYBOX"));; 
	...
	SM:addObject(Identifiers("PROP", "SKYBOX"), level2, vec3(0,-5000,-4000), ResourceList("model", "SKYBOX"));; 
